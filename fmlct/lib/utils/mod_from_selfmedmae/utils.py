"""
from `https://github.com/cvlab-stonybrook/SelfMedMAE/blob/main/lib/utils.py`
"""
import os
import sys
...
def get_conf():
    ...
    #conf_file = "/media/cz/disk14/CODE/MAE/code/SelfMedMAE-main/configs/mae3d_btcv_1gpu.yaml"
